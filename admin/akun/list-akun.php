...
<div class="container shadow py-4 mt-5">
            ...
            <div class="p-5 mb-4 bg-light rounded-3 height: 4rem">
                    <h3 class="display-7 bi-key"> Daftar akun terdaftar</h3>
            </div>
    ...
    <tbody>
        ...
        while($siswa = mysqli_fetch_array($query)){
            ...
            echo "<td>";
            echo "<a href='form-editakun.php?id=".$siswa['id']."'class='btn btn-warning'>Edit</a> ";   
            echo "<a href='hapus-akun.php?id=".$siswa['id']. "' class='btn btn-danger'>Hapus</a>";
    ...
    <a href="../../form-buatakun.php">
        <div class="d-grid gap-2">
            <button class="btn btn-success" type="button">[+] Tambah Baru</button>
        </div>
     </a>
